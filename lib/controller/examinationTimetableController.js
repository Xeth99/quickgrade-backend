...
exports.getExamTimetable = exports.createExamTimetable = void 0;
...
const createExamTimetable = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { examId, courseId, sessionId, examDate, status } = req.body;
        if (!examId || !courseId || !sessionId || !examDate || !status) {
            res.status(400).json({ message: "All fields are required" });
        }
        const examTimetable = yield examinationTimetableModel_1.ExaminationTimetable.create({
            examId,
            courseId,
            sessionId,
            examDate,
