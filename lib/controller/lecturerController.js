...
const setExamQuestions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { courseId, lecturerId, departmentId, sessionId, semesterId, examDuration, examInstruction, examDate, objectiveScore, totalScore, totalNoOfQuestions, } = req.body;
        if (!courseId ||
            !lecturerId ||
            !departmentId ||
            !sessionId ||
