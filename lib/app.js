...
const facultyRoute_1 = __importDefault(require("./routes/facultyRoute"));
...
const semesterRoute_1 = __importDefault(require("./routes/semesterRoute"));
...
app.use((0, express_session_1.default)({
    secret: (_b = process.env.SESSION_SECRET) !== null && _b !== void 0 ? _b : "",
    resave: false,
    saveUninitialized: true,
    cookie: {
        httpOnly: true,
...
app.use("/faculty", facultyRoute_1.default);
app.use("/department", departmentRoute_1.default);
app.use("/session", sessionRoute_1.default);
app.use("/semester", semesterRoute_1.default);
